...
const graphData = {
  nodes: [
    ...
    { id: '10', name: '伤亡', category: 2, symbolSize: 30 },
    { id: '11', name: '台湾', category: 0, symbolSize: 30 },
    { id: '12', name: '中国', category: 0, symbolSize: 45 },
    { id: '13', name: '美国', category: 0, symbolSize: 35 },
    { id: '14', name: '奥运会', category: 2, symbolSize: 30 },
    { id: '15', name: '山体滑坡', category: 2, symbolSize: 30 },
    { id: '16', name: '激素', category: 4, symbolSize: 30 },
    { id: '17', name: '股票', category: 1, symbolSize: 30 },
    { id: '18', name: '文旅', category: 2, symbolSize: 30 },
    { id: '19', name: '社保', category: 2, symbolSize: 30 },
    { id: '20', name: '三星堆', category: 3, symbolSize: 30 },
    { id: '21', name: '台风', category: 2, symbolSize: 30 },
    { id: '22', name: '地震', category: 2, symbolSize: 30 },
    { id: '23', name: '致癌', category: 2, symbolSize: 30 },
  ],
  links: [
